...
export default function ProfilePage() {
    ...
    useEffect(() => {
        async function fetchPaymentStatus() {
            try {
                setLoading(true)
                const response = await fetch(`/api/payments/stripe/check-payment-status/${user?.stripeAccountId}`)
                        ...
                        {user.stripeAccountId && (
                            <Card className="mb-6 border-0 shadow-md">
                                ...
                                <CardContent className="space-y-4">
                                    <div>
                                        <label className="text-sm font-semibold text-muted-foreground">Account ID</label>
                                        <p className="text-sm text-foreground mt-1 font-mono break-all">{user.stripeAccountId}</p>
                                    </div>
                                    ...
                                    {loading ? (
                                        ...
                                        <>
                                            ...
                                            <div className="pt-4 space-y-3">
                                                <label className="text-sm font-semibold text-muted-foreground">Setup Status</label>
                                            ...
                                            {paymentStatus.setupStatus.requirements.currently_due.length > 0 && (
                                                <div className="pt-4">
                                                    <label className="text-sm font-semibold text-muted-foreground">Items Due</label>
